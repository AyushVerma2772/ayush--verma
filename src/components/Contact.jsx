...
const Contact = () => {
    ...
    const serviceId = "service_rznr4an";
    const templateId = "template_elmtqpd";
    const publicKey = "39Tk-Nf1N20xxIk5y";
        ...
        <>
            <Wrapper id='contact' className='tag'>
                ...
                <Container className='d-flex' >
                    ...
                    <ContactForm className='d-flex' method='post' onSubmit={e => handleSubmit(e)} >
                        <Label htmlFor="">Name:
                ...
                <IconContainer className='d-flex' >
                    <InnerContainer className='d-flex' >
                        ...
                        <a href="https://www.instagram.com/ayush_verma.avh/" target="_blank" rel="noreferrer" className='link'><BsInstagram className='icon' id='instagram-icon' /></a>
